...
namespace Demo
{
    ConvexHull::ConvexHull() : points{}
    {
        ...
        this->cross = [](const ImVec2 &p0, const ImVec2 &p1, const ImVec2 &p2) -> bool
        {
    ...
    void ConvexHull::AddPoints(char *__points)
    {
        ...
        {
            this->points.push_back(ImVec2(
                std::stoi(points_str[i]),
                std::stoi(points_str[i + 1])));
        }
    }

    void ConvexHull::SortPoints()
    {
        std::sort(points.begin(), points.end(), [](ImVec2 &p1, ImVec2 &p2)
                  { return p1.x < p2.x; });
    }
